...
HikVision::HikVision() {
    exposuretime = this->declare_parameter("hikvision.exposure_time", 500);  
    autoexposure = this->declare_parameter("hikvision.auto_exposure", false);  
    autobalance = this->declare_parameter("hikvision.auto_whitebalance", true); 
    RCLCPP_INFO(this->get_logger(), "HikVision Start\n");
}
