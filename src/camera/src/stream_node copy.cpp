    ...
    do 
    {
        ...
        if (nRet == MV_OK)
        {
            printf("Now you GetOneFrame, Width[%d], Height[%d], nFrameNum[%d]\n\n", 
                stImageInfo.nExtendWidth, stImageInfo.nExtendHeight, stImageInfo.nFrameNum);
            ...
            case 1: 
                {
                    ...
                    pDataForRGB = (unsigned char*)malloc(stImageInfo.nExtendWidth * stImageInfo.nExtendHeight * 4 + 2048);
                    if (NULL == pDataForRGB)
                    {
                    ...
                    stConvertParam.nDstBufferSize = stImageInfo.nExtendWidth * stImageInfo.nExtendHeight *  4 + 2048;
            ...
            case 2:
                {
                    pDataForSaveImage = (unsigned char*)malloc(stImageInfo.nExtendWidth * stImageInfo.nExtendHeight * 4 + 2048);
                    ...
                    stSaveParam.nBufferSize = stImageInfo.nExtendWidth * stImageInfo.nExtendHeight * 4 + 2048;
                    stSaveParam.nWidth      = stImageInfo.nExtendWidth; 
                    stSaveParam.nHeight     = stImageInfo.nExtendHeight; 
                    stSaveParam.pData       = pData;
                    stSaveParam.nDataLen    = stImageInfo.nFrameLenEx;
